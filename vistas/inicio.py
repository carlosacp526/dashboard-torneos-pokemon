...
""", unsafe_allow_html=True)
    ...
    with col_c:
        st.markdown("""
        <div class="nav-section">
            <div class="nav-section-title">🏅 Historico</div>
        </div>""", unsafe_allow_html=True)
        st.markdown("- 🏆 Salón de la Fama\n- 📜 Historial de combates")
        if st.button("➡️ Ir a Historico", use_container_width=True, key="btn_rankings"):
    ...
    with col_e:
        st.markdown("""
        <div class="nav-section">
            <div class="nav-section-title">🤖 User Rate </div>
        </div>""", unsafe_allow_html=True)
        st.markdown("- 📊 Ladder de Ratio de uso ")
